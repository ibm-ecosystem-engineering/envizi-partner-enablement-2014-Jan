...
1. Follow the instructions to [generate the API Access Token](../202-api-access-token)

2. Copy and save the access token into your local file system which will be leveraged in the following sections.

## 3 Retrieve Report Names
...
#### 6.3 Retrieve Report Parameters
